...
public class CreateUser {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(User request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<User, CreateUserResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(User request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(User request) throws Exception {
        ...
        @Override
        public CreateUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUserResponse.Builder resBuilder =
                    CreateUserResponse
                            .builder()
            ...
            CreateUserResponse res = resBuilder.build();
