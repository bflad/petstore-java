...
public class GetPetById {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetPetByIdRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetPetByIdRequest, GetPetByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetPetByIdRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetPetByIdRequest request) throws Exception {
        ...
        @Override
        public GetPetByIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetPetByIdResponse.Builder resBuilder =
                    GetPetByIdResponse
                            .builder()
            ...
            GetPetByIdResponse res = resBuilder.build();
