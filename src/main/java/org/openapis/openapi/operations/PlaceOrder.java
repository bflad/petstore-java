...
public class PlaceOrder {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(Order request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<Order, PlaceOrderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(Order request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(Order request) throws Exception {
            HttpRequest r = onBuildRequest(request);
            HttpResponse<InputStream> httpRes;
            try {
                httpRes = client.send(r);
                if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "404", "405", "4XX", "5XX")) {
        ...
        @Override
        public PlaceOrderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            PlaceOrderResponse.Builder resBuilder =
                    PlaceOrderResponse
                            .builder()
            ...
            PlaceOrderResponse res = resBuilder.build();
            ...
            if (Utils.statusCodeMatches(response.statusCode(), "405", "4XX")) {
                // no content
                throw new APIException(
                        response,
                        response.statusCode(),
