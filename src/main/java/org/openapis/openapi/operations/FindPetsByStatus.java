...
public class FindPetsByStatus {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(FindPetsByStatusRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<FindPetsByStatusRequest, FindPetsByStatusResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(FindPetsByStatusRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(FindPetsByStatusRequest request) throws Exception {
        ...
        @Override
        public FindPetsByStatusResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            FindPetsByStatusResponse.Builder resBuilder =
            ...
            FindPetsByStatusResponse res = resBuilder.build();
