...
public class GetOrderById {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetOrderByIdRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetOrderByIdRequest, GetOrderByIdResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetOrderByIdRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetOrderByIdRequest request) throws Exception {
        ...
        @Override
        public GetOrderByIdResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetOrderByIdResponse.Builder resBuilder =
            ...
            GetOrderByIdResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Order out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withOrder(out);
