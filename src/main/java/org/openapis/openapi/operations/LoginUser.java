...
public class LoginUser {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(LoginUserRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<LoginUserRequest, LoginUserResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(LoginUserRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(LoginUserRequest request) throws Exception {
        ...
        @Override
        public LoginUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            LoginUserResponse.Builder resBuilder =
                    LoginUserResponse
                            .builder()
            ...
            LoginUserResponse res = resBuilder.build();
