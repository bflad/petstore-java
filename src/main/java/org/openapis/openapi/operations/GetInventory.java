...
public class GetInventory {
    ...
    public static class Sync extends Base
            implements RequestlessOperation<GetInventoryResponse> {
        ...
        public HttpResponse<InputStream> doRequest() throws Exception {
            ...
            try {
                ...
                if (Utils.statusCodeMatches(httpRes.statusCode(), "401", "404", "4XX", "5XX")) {
        ...
        @Override
        public GetInventoryResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetInventoryResponse.Builder resBuilder =
            ...
            GetInventoryResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    Map<String, Integer> out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withObject(out);
