...
public class DeleteUser {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteUserRequest, DeleteUserResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(DeleteUserRequest request) throws Exception {
        ...
        @Override
        public DeleteUserResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteUserResponse.Builder resBuilder =
                    DeleteUserResponse
                            .builder()
            ...
            DeleteUserResponse res = resBuilder.build();
