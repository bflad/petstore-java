...
public class GetUserByName {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(GetUserByNameRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<GetUserByNameRequest, GetUserByNameResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(GetUserByNameRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(GetUserByNameRequest request) throws Exception {
        ...
        @Override
        public GetUserByNameResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            GetUserByNameResponse.Builder resBuilder =
            ...
            GetUserByNameResponse res = resBuilder.build();
            
            if (Utils.statusCodeMatches(response.statusCode(), "200")) {
                if (Utils.contentTypeMatches(contentType, "application/json")) {
                    User out = Utils.mapper().readValue(
                            response.body(),
                            new TypeReference<>() {
                            });
                    res.withUser(out);
