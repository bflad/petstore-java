...
public class DeleteOrder {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(DeleteOrderRequest request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<DeleteOrderRequest, DeleteOrderResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(DeleteOrderRequest request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(DeleteOrderRequest request) throws Exception {
        ...
        @Override
        public DeleteOrderResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            DeleteOrderResponse.Builder resBuilder =
                    DeleteOrderResponse
                            .builder()
            ...
            DeleteOrderResponse res = resBuilder.build();
