...
public class CreateUsersWithListInput {
    ...
    static abstract class Base {
        ...
        HttpRequest buildRequest(List<User> request) throws Exception {
    ...
    public static class Sync extends Base
            implements RequestOperation<List<User>, CreateUsersWithListInputResponse> {
        public Sync(@Nonnull SDKConfiguration sdkConfiguration) {
            super(sdkConfiguration);
        }

        private HttpRequest onBuildRequest(List<User> request) throws Exception {
        ...
        @Override
        public HttpResponse<InputStream> doRequest(List<User> request) throws Exception {
        ...
        @Override
        public CreateUsersWithListInputResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            CreateUsersWithListInputResponse.Builder resBuilder =
            ...
            CreateUsersWithListInputResponse res = resBuilder.build();
