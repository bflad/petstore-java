...
public class AddPet {
    ...
    public static class Sync extends Base
            implements RequestOperation<Pet, AddPetResponse> {
        ...
        public HttpResponse<InputStream> doRequest(Pet request) throws Exception {
            ...
            try {
                ...
                if (Utils.statusCodeMatches(httpRes.statusCode(), "405", "4XX", "5XX")) {
        ...
        @Override
        public AddPetResponse handleResponse(HttpResponse<InputStream> response) throws Exception {
            String contentType = response
                    .headers()
                    .firstValue("Content-Type")
                    .orElse("application/octet-stream");
            AddPetResponse.Builder resBuilder =
                    AddPetResponse
                            .builder()
            ...
            AddPetResponse res = resBuilder.build();
