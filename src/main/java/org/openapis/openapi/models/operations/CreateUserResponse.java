...
public class CreateUserResponse implements Response {
     ...
     * HTTP response content type for this operation
     */
    public CreateUserResponse withContentType(@Nonnull String contentType) {
     ...
     * HTTP response status code for this operation
     */
    public CreateUserResponse withStatusCode(int statusCode) {
        this.statusCode = statusCode;
        return this;
    }
     ...
     * Raw HTTP response; suitable for custom response parsing
     */
    public CreateUserResponse withRawResponse(@Nonnull HttpResponse<InputStream> rawResponse) {
     ...
     * Successful operation
     */
    public CreateUserResponse withUser(@Nullable User user) {
        this.user = user;
        return this;
    }
    ...
    public String toString() {
        return Utils.toString(CreateUserResponse.class,
